<?php 
    ...
    $sql = "insert into `house_seekers`(FirstName,LatstName,Username,Email,Password) values('$firstname','$lastname','$username','$email','$password')";
    $result = mysqli_query($con, $sql);
    if($result){
    header("Location: house-seeker-log-in.php");
    }else {
...
<body>
    ...
    <div class="container">
        <h1>sign-up</h1>
        <form action="house-seekers-sign-up.php" method="post" id="form">
